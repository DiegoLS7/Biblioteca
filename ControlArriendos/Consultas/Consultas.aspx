<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Consultas.aspx.cs" Inherits="ControlArriendos.Consultas.Consultas" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    ...
    document.getElementById('<%= txtAutor.ClientID %>').addEventListener('keydown', manejarEnter);
...
<body>
    <div class="contenedorLibro" align="center" style="width: 1800px; margin-top: 25px;">
       ...
       <br />
        <br />
     <h2 class="Titulos" style="color: black; text-shadow: 2px 2px 4px #555;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Consulta Libros por Autor </h2>
  <br />    
<table  class="Tabla_Estructura"  >
    ...
    <tr align="center">
       <td class="auto-style14" >
           ...
           <asp:Label ID="Label5" runat="server"  ForeColor="Black" CssClass="Texto" Text="Autor" Font-Size="14pt"></asp:Label>
        </td>
       <td class="auto-style12" >
             <asp:TextBox ID="txtAutor" runat="server" MaxLength="18" Height="24px" 
             Width="200px" CssClass="textbox" 
             OnTextChanged="txtRut_TextChanged" BackColor="#e5f4fc"></asp:TextBox>

            <asp:RadioButton ID="FiltraCodigo" runat="server" Text="Filtra Código" GroupName="filtroGroup" BackColor="#e5f4fc" style="border: 1px solid #000; color: #000;" />
    ...
    <td class="auto-style25" style="width: 3px">              
      ...
      <tr>
        <td colspan="6">       
                         <asp:GridView ID="GridP" runat="server" class="" AutoGenerateColumns="False"  HeaderStyle-ForeColor="White" CellPadding="3" ShowFooter="True" HorizontalAlign="Center" AllowPaging="True" CssClass="Tabla_empleados" Width="750px" Style="margin-top: 0px" PageSize="10" AllowSorting="True" OnPageIndexChanging="GridP_PageIndexChanging" Height="80px" OnSelectedIndexChanged="GridP_SelectedIndexChanged"> 
                ...
                <Columns>
                   ...
                   <asp:TemplateField HeaderText="Editorial">
                    ...
                    <asp:TemplateField HeaderText="Ultimo">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox6" runat="server" Width="110px" ReadOnly="true" Text='<%# Eval("Ultimo Lector")  %>' ></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                   ...
                   <asp:TemplateField HeaderText="Disponibilidad">
                    ...
                    <asp:Label ID="Label8" runat="server" Text='<%# Eval("estado")%>' Visible="False"></asp:Label>
                    </EditItemTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="Fecha Prestamo">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox9" runat="server" Width="110px" ReadOnly="true" Text='<%# Eval("Fecha Prestamo") %>' ></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Fecha Devolucion">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox10" runat="server" Width="110px" ReadOnly="true" Text='<%# Eval("Fecha Devolucion") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
