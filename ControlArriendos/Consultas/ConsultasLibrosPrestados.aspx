<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ConsultasLibrosPrestados.aspx.cs" Inherits="ControlArriendos.Consultas.ConsultasLibrosPrestados" %>
...
<script>
    function manejarEnter(e) {
        if (e.key === "Enter") {
            ...
            document.getElementById('<%= BtnBuscar.ClientID %>').click(); // Simular clic en el botón BtnBuscar
            }
        }

        // Asignar la función manejarEnter al evento keydown del TextBox txtAutor
        document.getElementById('<%= txtTitulo.ClientID %>').addEventListener('keydown', manejarEnter)
</script>
...
<body>
    <div class="contenedorLibro" align="center" style="width: 1800px; margin-top: 25px;">
       ...
       <br />
        <br />
     <h2 class="Titulos" style="color: black; text-shadow: 2px 2px 4px #555;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Consulta de Libros Prestados  </h2>
  <br />    
<table  class="Tabla_Estructura"  >
    ...
    <tr align="center">
       <td class="auto-style14" >
           ...
           <asp:Label ID="Label5" runat="server"  ForeColor="Black" CssClass="Texto" Text="Titulo" Font-Size="14pt"></asp:Label>
        </td>
       <td class="auto-style12" >
                        <td class="auto-style12" style="height: 44px; Width: 160px"">
                            <asp:TextBox ID="txtTitulo" runat="server" CssClass="textbox" Height="24px" 
                                ...
                                OnTextChanged="txtTitulo_TextChanged" BackColor="#e5f4fc" ></asp:TextBox>
            ...
            <td
                ...
                <div style="border: 1px solid black; background-color: #e5f4fc; padding: 10px; display: inline-block; color: black;">

                    <asp:RadioButton ID="FiltraCodigo" runat="server" Text="Filtra Código" GroupName="filtroGroup" Checked="true"  />
                </div>
            </td>
            <td
                <div style="border: 1px solid black; background-color: #e5f4fc; padding: 10px; display: inline-block; color: black;">
                    <asp:RadioButton ID="FiltraTitulo" runat="server" Text="Filtra Título" GroupName="filtroGroup" />
       ...
       <td class="auto-style29">               
            ...
            <asp:Button ID="BtnBuscar" runat="server" Text="Buscar"  Height="32px" Width="100px" OnClick="BuscarLibro_Click" style="margin-left: 160px;"/>
        </td>
    ...
    <td class="auto-style25" style="width: 3px">              
      ...
      <tr>
        <td colspan="6">       
                         <asp:GridView ID="GridP" runat="server" EnableViewState="true" class="" AutoGenerateColumns="False"  HeaderStyle-ForeColor="White" CellPadding="3" ShowFooter="True" HorizontalAlign="Center" AllowPaging="True" CssClass="Tabla_empleados" Width="800px" Style="margin-left: 105px; margin-top: 0px;" PageSize="8" AllowSorting="True" OnPageIndexChanging="GridP_PageIndexChanging" Height="80px" OnSelectedIndexChanged="GridP_SelectedIndexChanged"> 
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Codigo">
                        <ItemTemplate>
                            <asp:Label ID="Label1" runat="server" Width="135px" Text='<%# Eval("Codigo")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Titulo" >
                        <ItemTemplate>
                            <asp:Label ID="Label2" runat="server" Width="135px" Text='<%# Eval("Titulo") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Autor">
                        <ItemTemplate>
                            <asp:Label ID="Label4" runat="server" Width="135px" Text='<%# Eval("Autor") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Prestado A.">
                        <ItemTemplate>
                            <asp:Label ID="Label6" runat="server" Width="135px" Text='<%# Eval("Ultimo Lector") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
