...
{
    public partial class ConsultasLibrosPrestados : System.Web.UI.Page
    {
        string Titulo;
        string Filtro;
        ...
        public void BuscarListaLibro()
        {
            ...
            if (Filtro == "CODIGO")
            {
                ...
                BuscarLibroTodosUbicacion = PreparaAcceso.BuscarLibroTodosPrestados(Titulo, Filtro, CadenaConexion);
