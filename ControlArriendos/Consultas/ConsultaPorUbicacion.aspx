<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ConsultaPorUbicacion.aspx.cs" Inherits="ControlArriendos.Consultas.ConsultaPorUbicacion" %>
...
<script>
    ...
    document.getElementById('<%= txtUbicacion.ClientID %>').addEventListener('keydown', manejarEnter)
...
<body>
    <div class="contenedorLibro" align="center" style="width: 1800px; margin-top: 25px;">
       ...
       <br />
        <br />
     <h2 class="Titulos" style="color: black; text-shadow: 2px 2px 4px #555;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Consulta Libros por Ubicación  </h2>
  <br />    
<table  class="Tabla_Estructura"  >
    ...
    <tr align="center">
       <td class="auto-style14" >
           ...
           <asp:Label ID="Label5" runat="server"  ForeColor="Black" CssClass="Texto" Text="Ubicación" Font-Size="14pt"></asp:Label>
        </td>
